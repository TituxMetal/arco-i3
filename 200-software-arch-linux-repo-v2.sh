...
sudo pacman -S --noconfirm --needed firefox firefox-i18n-fr firefox-ublock-origin firefox-dark-reader
sudo pacman -S --noconfirm --needed firefox-developer-edition firefox-developer-edition-i18n-fr
